...
<body>
	<div class="container">
		<form id="caseReq_Update_Form" action="doUpdate.action" method="POST">
			<h5 class="display-3">修改畫面</h5>
			<div class="row">
				<div class="col-md-6 mb-3">
					<label for="caseReq.caseNo">工作編號</label>
					<label class="form-control"><s:property value="caseReq.caseNo" /></label>
					<input type="text" name="caseReq.caseNo" value="<s:property value="caseReq.caseNo" />" hidden/>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 mb-3">
			...
			<div class="row">
				<div class="col-md-6 mb-3">
					...
					<s:select cssClass="custom-select d-block w-100" headerKey=""
						headerValue="全部" list="employees" listKey="empId" listValue="label"
			...
			<div class="row">
				<div class="col-md-6 mb-3">
					...
					<input type="date" class="form-control" name="caseReq.startDate" value="<s:date name="caseReq.startDate" format="yyy-MM-dd" />" />

				</div>
				<div class="col-md-6 mb-3">
					<label for="caseReq.end">辦理迄日</label>
					<input type="date" class="form-control" name="caseReq.endDate" value="<s:date name="caseReq.endDate" format="yyy-MM-dd" />" />
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 mb-3">
					<label for="caseReq.workItemDesc">工作項目</label>
					<textarea class="form-control" name="caseReq.workItemDesc"><s:property value="caseReq.workItemDesc" /></textarea>
				</div>
			</div>
		</form>
		<p class="text-right">
